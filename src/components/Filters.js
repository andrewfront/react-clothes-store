        ...
        <div className="form-control">
          ...
          <div>
            {categories.map((c, index) => {
              return <button key={index} onClick={updateFilters} name="category" type='button' className={`${category === c.toLowerCase() ? 'actice' : null}`}>{c}</button>
            })}
          </div>
        </div>
        <div className="form-control">
...
{colors.map((c, index) => {
  ...
  return <button key={index} name="color" style={{background: c}} className={`${color === c ? 'color-btn active' : 'color-btn'}`} data-color={c} onClick={updateFilters}>{color === c? <FaCheck></FaCheck> : null}</button>
})}
          </div>
        </div>
        <div className="form-control">
