...
<div className="btn-container">
  <button type='button' className={`${grid_view ? 'active' : null}`} onClick={setGridView}><BsFillGridFill></BsFillGridFill></button>
  <button type='button' className={`${!grid_view ? 'active' : null}`} onClick={setListView}><BsList></BsList></button>
</div>
<p>
